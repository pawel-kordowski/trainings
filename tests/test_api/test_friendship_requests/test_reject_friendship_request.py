...
class TestRejectFriendshipRequest:
    ...
    def test_returns_error_when_exception_occur(
        ...
        mocked_friendship_request_service.reject_friendship_request.side_effect = (
        ...
        mocked_friendship_request_service.reject_friendship_request.assert_awaited_once_with(  # noqa
